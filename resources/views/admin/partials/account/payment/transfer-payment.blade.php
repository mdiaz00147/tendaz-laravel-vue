<div class="choose-period list-unstyled big-radio-container selections chosen-period text-center p-top">
    <div class="col-xs-10 col-xs-offset-1 text-left selection transfer  one-month-selection m-bottom selected" data-period="1" data-price="{{ $plan->price }}" data-credit-until=''>
...
<div class="choose-period list-unstyled big-radio-container selections chosen-period text-center p-top">
    <div class="col-xs-10 col-xs-offset-1 text-left selection transfer  one-month-selection m-bottom " data-period="3" data-price="{{ ($plan->price * 3) * 0.90 }}" data-credit-until=''>
        <div class="p-top-half p-bottom-half text-black row">
            <div class="col-md-1">
                <i class="fa fa-circle-o"></i>
                <i class="fa fa-check-circle-o"></i>
...
<div class="choose-period list-unstyled big-radio-container selections chosen-period text-center p-top">
    <div class="col-xs-10 col-xs-offset-1 text-left selection transfer  one-month-selection m-bottom " data-period="12" data-price="{{ ($plan->price * 12) * 0.80 }}" data-credit-until=''>
        <div class="p-top-half p-bottom-half text-black row">
            <div class="col-md-1">
                <i class="fa fa-circle-o"></i>
                <i class="fa fa-check-circle-o"></i>
...
<!-- Boton pago con transferencia bancaria -->
<div class="checkout-confirm-container confirm">
    <div class="checkout-confirm">
        <div style=" display: none ; ;margin-left: 8.2%"><strong>Medio de pago:</strong> <span class="confirm-method">Transferencia bancaria o dep&oacute;sito</span></div>
        ...
        <form id="submit_form-transfer" method="post" action="{{ url("/admin/account/checkout/finish/") }}" class="no-padding submit_form">
            <input type="hidden" class="input_method" id="input_method" name="method" value="transfer">
        ...
        <div class="panel-footer text-center">
            <div class="text-center">
                <button id="confirm_button-transfer" class="btn btn-default-tendaz confirm_button m-half-bottom m-half-top">
                    Contratar plan

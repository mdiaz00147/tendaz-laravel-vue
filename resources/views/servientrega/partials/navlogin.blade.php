  <nav class="navbar navbar-default">
   ...
   <li  data-menuanchor="se_container-1"><a  class="nopad brand_anchor" href="{{url('/')}}" ><img src="{{asset('servientrega/img/icono_servi.png')}}" class="brand_logo_image img-responsive"></a></li> 
          <li  data-menuanchor="se_container-2"><a href="{{url('/#about')}}">Nosotros <span class="sr-only">(current)</span></a></li>

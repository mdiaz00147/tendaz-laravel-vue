...
(function() {
    ...
    this.Stripe = function() {
        ...
        return a.version = 2, a.endpoint = "https://api.stripe.com/v1", a.setPublishableKey = function(b) {
            ...
            var d, e, f;
            if (e = "POST" === b.method && "object" == typeof(null != (f = b.data) ? f.card : void 0), c || (b.data.payment_user_agent ? this._isChannel || (b.data.payment_user_agent = "" + b.data.payment_user_agent + " (" + a.stripejs_ua + ")") : b.data.payment_user_agent = a.stripejs_ua), "iframe" === this._transport) {
        ...
        return a.validate = function(a, b) {
            ...
            if (Stripe.utils.underscoreKeys(a), "string" == typeof a.exp) {
                try {
                    e = Stripe.utils.parseExpString(a.exp), a.exp_month = e[0], a.exp_year = e[1]
                } catch (f) {
                    a.exp_month = 0, a.exp_year = 0
                }
                delete a.exp
            }
            return a
        ...
        return k(b, a), b.tokenName = "card", b.whitelistedAttrs = ["number", "cvc", "exp", "exp_month", "exp_year", "name", "address_line1", "address_line2", "address_city", "address_state", "address_zip", "address_country", "currency"], b.createToken = function(a, c, d) {
            ...
            return !!/^\d+$/.test(e) && (!!/^\d+$/.test(b) && (1 <= e && e <= 12 && (2 === b.length && (b = b < 70 ? "20" + b : "19" + b), 4 === b.length && (d = new Date(b, e), c = new Date, d.setMonth(d.getMonth() - 1), d.setMonth(d.getMonth() + 1, 1), d > c))))
    ...
    }(this.Stripe.token), this.Stripe.piiData = function(a) {
        function b() {
            return b.__super__.constructor.apply(this, arguments)
        }
    ...
    }(), this.Stripe.bitcoinReceiver = function(a) {
        function b() {
            return b.__super__.constructor.apply(this, arguments)
        }
        return k(b, a), b._whitelistedAttrs = ["amount", "currency", "email", "description"], b.createReceiver = function(a, b) {
            var c;
        ...
        }, b.cancelReceiverPoll = function(a) {
            return b._cancelPoll(a)
        }, b
    }(this.Stripe._poller), this.Stripe.source = function(a) {
        function b() {
            return b.__super__.constructor.apply(this, arguments)
        }
        return k(b, a), b.get = function(a, b, c) {
            var d, e;
            if (!a) throw new Error("sourceId required");
            if (!b) throw new Error("clientSecret required");
            return d = Stripe.key || Stripe.publishableKey, Stripe.utils.validateKey(d), e = {}, e.key = d, e.client_secret = b, Stripe.request({
                url: "" + Stripe.endpoint + "/sources/" + a,
                data: e,
                success: function(a, b) {
                    return "function" == typeof c ? c(b, a) : void 0
                },
                complete: Stripe.complete(c, "A network error has occurred loading data from Stripe. Please try again."),
                timeout: 4e4
            })
        ...
        return a.create = function(a, b) {
            var c;
            if ("object" != typeof a) throw new Error("params must be an object.");
            if ("function" != typeof b) throw new Error("callback must be a function.");
            return a.key || (a.key = Stripe.key || Stripe.publishableKey), a.return_url || (a.return_url = "_callback"), Stripe.utils.validateKey(a.key), c = {
                url: "" + Stripe.endpoint + "/3d_secure",
                data: a,
                method: "POST",
                headers: {},
                success: function(a, c) {
            ...
            }, Stripe._language && (c.headers["Accept-Language"] = Stripe._language), Stripe.request(c), null
        }, a.createIframe = function(a, b, c) {
            var d, e;
            if (e = null, !Stripe.validator.isUrl(a)) throw new Error("redirectUrl must be a valid URL.");
            if (!Stripe.validator.isElementOrId(b)) throw new Error("parentElement must be a DOM Element, or the ID of a DOM element.");
            if ("function" != typeof c) throw new Error("callback must be a function.");
            return d = function(a, b) {
                var d, f;
                try {
                    f = Stripe.JSON.parse(a)
                } catch (g) {
                    throw d = g, Stripe.reportError("InvalidJSON-3DSecureCallback"), new Error("Stripe.js received invalid JSON")
                }
                return e.destroy(), c(f)
            }, e = new Stripe.easyXDM.Socket({
    ...
    for (h = 0, i = a.length; h < i; h++) e = a[h], this.Stripe[e] = this.Stripe.card[e];
    this.Stripe.stripejs_ua = "stripe.js/1b0d1ee", "undefined" != typeof module && null !== module && (module.exports = this.Stripe), "function" == typeof define && define("stripe", [], function(a) {
        return function() {
            return a.Stripe
        }
    }(this))

...
return [
	...
	*/
	...
	'themes' => [
		'default'               => ['views-path'    => 'themes.default'],
				'minimal'                => ['views-path'    => 'themes.theme1'],
				'big_store'             => ['views-path'    => 'themes.theme2'],
				'tech'                  => ['views-path'    => 'themes.theme3'],
				'shopping_center'      => ['views-path'    => 'themes.theme4'],
